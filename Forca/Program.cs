        ...
        try
        {
            do
            {
                ...
                do
                {
                    ...
                    {
                        throw new Exception("Você não digitou uma letra!");

                        letra = Console.ReadLine().ToLower();
                    }

                    if (verificaseLetra == false)
                    {
                    }
    ...
    static void Main(string[] args)
    {
        ...
        if (x != -1)
        {
            do
            {
                ...
                Console.WriteLine($"\nQuantidade tentativas erradas restantes:{Forca.Quantidade_Tentativas_restantes(lst_letra_errada)}");

                Console.WriteLine("");
                Console.Write("Letras Totais:");
